...
namespace Wgpu {
	public static class Wgpu {
		...
		public struct ComputePassEncoder : this(void* Handle) {
			...
			public void InsertDebugMarkerColor(c_char* markerLabel, uint32 color) => Wgpu.ComputePassEncoderInsertDebugMarkerColor(this, markerLabel, color);
			public void PushDebugGroupColor(c_char* groupLabel, uint32 color) => Wgpu.ComputePassEncoderPushDebugGroupColor(this, groupLabel, color);
		}
		...
		public struct RenderPassEncoder : this(void* Handle) {
			...
			public void InsertDebugMarkerColor(c_char* markerLabel, uint32 color) => Wgpu.RenderPassEncoderInsertDebugMarkerColor(this, markerLabel, color);
			public void PushDebugGroupColor(c_char* groupLabel, uint32 color) => Wgpu.RenderPassEncoderPushDebugGroupColor(this, groupLabel, color);
		}
		...
		public struct RequiredLimitsExtras {
			...
			public this(ChainedStruct chain, uint32 maxPushConstantSize) {
				this.chain = chain;
		...
		[LinkName("wgpuGetResourceUsageString")]
		public static extern c_char* GetResourceUsageString();
		...
		[LinkName("wgpuRenderPassEncoderInsertDebugMarkerColor")]
		public static extern void RenderPassEncoderInsertDebugMarkerColor(RenderPassEncoder renderPassEncoder, c_char* markerLabel, uint32 color);

		[LinkName("wgpuRenderPassEncoderPushDebugGroupColor")]
		public static extern void RenderPassEncoderPushDebugGroupColor(RenderPassEncoder renderPassEncoder, c_char* groupLabel, uint32 color);

		[LinkName("wgpuComputePassEncoderInsertDebugMarkerColor")]
		public static extern void ComputePassEncoderInsertDebugMarkerColor(ComputePassEncoder computePassEncoder, c_char* markerLabel, uint32 color);

		[LinkName("wgpuComputePassEncoderPushDebugGroupColor")]
		public static extern void ComputePassEncoderPushDebugGroupColor(ComputePassEncoder computePassEncoder, c_char* groupLabel, uint32 color);
